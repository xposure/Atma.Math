...
namespace  Atma.Math.Swizzle.Generated.Swizzle
{
    ...
    public class FloatSwizzleVec2Test
    {
        ...
        public void XYZW()
        {
            ...
            {
                var ov = new float2(9.5f, -1f);
                var v = ov.swizzle.yy;
                Assert.AreEqual(-1f, v.x);
                Assert.AreEqual(-1f, v.y);
            }
            {
                var ov = new float2(9.5f, 6f);
        ...
        public void RGBA()
        {
            ...
            {
                var ov = new float2(7f, -5.5f);
                var v = ov.swizzle.gr;
                Assert.AreEqual(-5.5f, v.x);
                Assert.AreEqual(7f, v.y);
            }
            {
                var ov = new float2(-4f, 7.5f);
        ...
        {
            {
                var v0 = new float2(-6f, 8.5f);
                var v1 = new float2(-3.5f, 3f);
                var v2 = v0.xy;
                v0.xy = v1;
                var v3 = v0.xy;
        ...
        public void InlineRGBA()
        {
            ...
            {
                var v0 = new float2(-6f, 5.5f);
                var v1 = new float2(-7f, -1.5f);
                var v2 = v0.rg;
                v0.rg = v1;
                var v3 = v0.rg;
