...
namespace Atma.Math
{
    ...
    public struct bool4x4 : IReadOnlyList<bool>, IEquatable<bool4x4>
    {
        ...
        /// </summary>
        public bool4x4(bool2 c0, bool2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public bool4x4(bool2 c0, bool2 c1, bool2 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public bool4x4(bool2 c0, bool2 c1, bool2 c2, bool2 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public bool4x4(bool3 c0, bool3 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public bool4x4(bool3 c0, bool3 c1, bool3 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public bool4x4(bool4 c0, bool4 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        public bool4 Column0
        {
            get
            {
                return new bool4(m00, m01, m02, m03);
            }
            set
            {
                m00 = value.x;
        ...
        public bool4 Column1
        {
            get
            {
                return new bool4(m10, m11, m12, m13);
            }
            set
            {
                m10 = value.x;
        ...
        public bool4 Column2
        {
            get
            {
                return new bool4(m20, m21, m22, m23);
            }
            set
            {
                m20 = value.x;
        ...
        public bool4 Column3
        {
            get
            {
                return new bool4(m30, m31, m32, m33);
            }
            set
            {
                m30 = value.x;
        ...
        public bool4 Row3
        {
            get
            {
                return new bool4(m03, m13, m23, m33);
            }
            set
            {
                m03 = value.x;
        ...
        /// </summary>
        public static bool4x4 Zero { get; } = new bool4x4(false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
        
        /// <summary>
        /// Predefined all-ones matrix
        /// </summary>
        public static bool4x4 Ones { get; } = new bool4x4(true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true);
        
        /// <summary>
        /// Predefined identity matrix
        /// </summary>
        public static bool4x4 Identity { get; } = new bool4x4(true, false, false, false, false, true, false, false, false, false, true, false, false, false, false, true);
        ...
        /// </summary>
        public bool Equals(bool4x4 rhs) => ((((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && (m02.Equals(rhs.m02) && m03.Equals(rhs.m03))) && ((m10.Equals(rhs.m10) && m11.Equals(rhs.m11)) && (m12.Equals(rhs.m12) && m13.Equals(rhs.m13)))) && (((m20.Equals(rhs.m20) && m21.Equals(rhs.m21)) && (m22.Equals(rhs.m22) && m23.Equals(rhs.m23))) && ((m30.Equals(rhs.m30) && m31.Equals(rhs.m31)) && (m32.Equals(rhs.m32) && m33.Equals(rhs.m33)))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is bool4x4 && Equals((bool4x4) obj);
        }
        ...
        /// </summary>
        public bool4x4 Transposed => new bool4x4(m00, m10, m20, m30, m01, m11, m21, m31, m02, m12, m22, m32, m03, m13, m23, m33);
