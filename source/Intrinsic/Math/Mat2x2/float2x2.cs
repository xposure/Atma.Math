...
namespace Intrinsic.Math
{
    ...
    public struct float2x2 : IReadOnlyList<float>, IEquatable<float2x2>
    {
        ...
        /// </summary>
        public static float2x2 Zero { get; } = new float2x2(0f, 0f, 0f, 0f);
        
        /// <summary>
        /// Predefined all-ones matrix
        /// </summary>
        public static float2x2 Ones { get; } = new float2x2(1f, 1f, 1f, 1f);
        
        /// <summary>
        /// Predefined identity matrix
        /// </summary>
        public static float2x2 Identity { get; } = new float2x2(1f, 0f, 0f, 1f);
        
        /// <summary>
        /// Predefined all-MaxValue matrix
        /// </summary>
        public static float2x2 AllMaxValue { get; } = new float2x2(float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue);
        
        /// <summary>
        /// Predefined diagonal-MaxValue matrix
        /// </summary>
        public static float2x2 DiagonalMaxValue { get; } = new float2x2(float.MaxValue, 0f, 0f, float.MaxValue);
        
        /// <summary>
        /// Predefined all-MinValue matrix
        /// </summary>
        public static float2x2 AllMinValue { get; } = new float2x2(float.MinValue, float.MinValue, float.MinValue, float.MinValue);
        
        /// <summary>
        /// Predefined diagonal-MinValue matrix
        /// </summary>
        public static float2x2 DiagonalMinValue { get; } = new float2x2(float.MinValue, 0f, 0f, float.MinValue);
        
        /// <summary>
        /// Predefined all-Epsilon matrix
        /// </summary>
        public static float2x2 AllEpsilon { get; } = new float2x2(float.Epsilon, float.Epsilon, float.Epsilon, float.Epsilon);
        
        /// <summary>
        /// Predefined diagonal-Epsilon matrix
        /// </summary>
        public static float2x2 DiagonalEpsilon { get; } = new float2x2(float.Epsilon, 0f, 0f, float.Epsilon);
        
        /// <summary>
        /// Predefined all-NaN matrix
        /// </summary>
        public static float2x2 AllNaN { get; } = new float2x2(float.NaN, float.NaN, float.NaN, float.NaN);
        
        /// <summary>
        /// Predefined diagonal-NaN matrix
        /// </summary>
        public static float2x2 DiagonalNaN { get; } = new float2x2(float.NaN, 0f, 0f, float.NaN);
        
        /// <summary>
        /// Predefined all-NegativeInfinity matrix
        /// </summary>
        public static float2x2 AllNegativeInfinity { get; } = new float2x2(float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity, float.NegativeInfinity);
        
        /// <summary>
        /// Predefined diagonal-NegativeInfinity matrix
        /// </summary>
        public static float2x2 DiagonalNegativeInfinity { get; } = new float2x2(float.NegativeInfinity, 0f, 0f, float.NegativeInfinity);
        
        /// <summary>
        /// Predefined all-PositiveInfinity matrix
        /// </summary>
        public static float2x2 AllPositiveInfinity { get; } = new float2x2(float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity);
        
        /// <summary>
        /// Predefined diagonal-PositiveInfinity matrix
        /// </summary>
        public static float2x2 DiagonalPositiveInfinity { get; } = new float2x2(float.PositiveInfinity, 0f, 0f, float.PositiveInfinity);
        ...
        /// </summary>
        public bool Equals(float2x2 rhs) => ((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && (m10.Equals(rhs.m10) && m11.Equals(rhs.m11)));
        ...
        /// </summary>
        public float2x2 Transposed => new float2x2(m00, m10, m01, m11);
        ...
        /// </summary>
        public float2x2 Adjugate => new float2x2(m11, -m01, -m10, m00);
        ...
        /// </summary>
        public static float2x2 CompMul(float2x2 A, float2x2 B) => new float2x2(A.m00 * B.m00, A.m01 * B.m01, A.m10 * B.m10, A.m11 * B.m11);
        
        /// <summary>
        /// Executes a component-wise / (divide).
        /// </summary>
        public static float2x2 CompDiv(float2x2 A, float2x2 B) => new float2x2(A.m00 / B.m00, A.m01 / B.m01, A.m10 / B.m10, A.m11 / B.m11);
        
        /// <summary>
        /// Executes a component-wise + (add).
        /// </summary>
        public static float2x2 CompAdd(float2x2 A, float2x2 B) => new float2x2(A.m00 + B.m00, A.m01 + B.m01, A.m10 + B.m10, A.m11 + B.m11);
        
        /// <summary>
        /// Executes a component-wise - (subtract).
        /// </summary>
        public static float2x2 CompSub(float2x2 A, float2x2 B) => new float2x2(A.m00 - B.m00, A.m01 - B.m01, A.m10 - B.m10, A.m11 - B.m11);
        
        /// <summary>
        /// Executes a component-wise + (add).
        /// </summary>
        public static float2x2 operator+(float2x2 lhs, float2x2 rhs) => new float2x2(lhs.m00 + rhs.m00, lhs.m01 + rhs.m01, lhs.m10 + rhs.m10, lhs.m11 + rhs.m11);
        
        /// <summary>
        /// Executes a component-wise + (add) with a scalar.
        /// </summary>
        public static float2x2 operator+(float2x2 lhs, float rhs) => new float2x2(lhs.m00 + rhs, lhs.m01 + rhs, lhs.m10 + rhs, lhs.m11 + rhs);
        
        /// <summary>
        /// Executes a component-wise + (add) with a scalar.
        /// </summary>
        public static float2x2 operator+(float lhs, float2x2 rhs) => new float2x2(lhs + rhs.m00, lhs + rhs.m01, lhs + rhs.m10, lhs + rhs.m11);
        ...
        /// </summary>
        public static bool2x2 operator<(float2x2 lhs, float2x2 rhs) => new bool2x2(lhs.m00 < rhs.m00, lhs.m01 < rhs.m01, lhs.m10 < rhs.m10, lhs.m11 < rhs.m11);
        
        /// <summary>
        /// Executes a component-wise lesser-than comparison with a scalar.
        /// </summary>
        public static bool2x2 operator<(float2x2 lhs, float rhs) => new bool2x2(lhs.m00 < rhs, lhs.m01 < rhs, lhs.m10 < rhs, lhs.m11 < rhs);
        
        /// <summary>
        /// Executes a component-wise lesser-than comparison with a scalar.
        /// </summary>
        public static bool2x2 operator<(float lhs, float2x2 rhs) => new bool2x2(lhs < rhs.m00, lhs < rhs.m01, lhs < rhs.m10, lhs < rhs.m11);
