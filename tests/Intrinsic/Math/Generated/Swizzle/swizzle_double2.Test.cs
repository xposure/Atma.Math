...
namespace  Intrinsic.Math.Swizzle.Generated.Swizzle
{
    ...
    public class DoubleSwizzleVec2Test
    {
        ...
        {
            {
                var ov = new double2(-0.5d, -4d);
                var v = ov.swizzle.xx;
                Assert.AreEqual(-0.5d, v.x);
                Assert.AreEqual(-0.5d, v.y);
            }
            {
                var ov = new double2(-4d, -4d);
            ...
            {
                var ov = new double2(2d, -8.5d);
                var v = ov.swizzle.xy;
                Assert.AreEqual(2d, v.x);
                Assert.AreEqual(-8.5d, v.y);
            }
            {
                var ov = new double2(8d, 7d);
            ...
            {
                var ov = new double2(-3.5d, 5d);
                var v = ov.swizzle.yx;
                Assert.AreEqual(5d, v.x);
                Assert.AreEqual(-3.5d, v.y);
            }
            {
                var ov = new double2(-6d, -3.5d);
        ...
        public void RGBA()
        {
            ...
            {
                var ov = new double2(-8d, 2d);
                var v = ov.swizzle.rg;
                Assert.AreEqual(-8d, v.x);
                Assert.AreEqual(2d, v.y);
            }
            {
                var ov = new double2(-4.5d, 1.0);
            ...
            {
                var ov = new double2(9d, 5.5d);
                var v = ov.swizzle.gr;
                Assert.AreEqual(5.5d, v.x);
                Assert.AreEqual(9d, v.y);
            }
            {
                var ov = new double2(-9d, -7.5d);
            ...
            {
                var ov = new double2(-1.5d, -7d);
                var v = ov.swizzle.gg;
                Assert.AreEqual(-7d, v.x);
                Assert.AreEqual(-7d, v.y);
            }
            {
                var ov = new double2(2.5d, -7.5d);
        ...
        public void InlineRGBA()
        {
            ...
            }
            {
                ...
                Assert.AreEqual(-2d, v2);
            }
            {
                var v0 = new double2(-5.5d, -4.5d);
                var v1 = new double2(-5.5d, 1.0);
                var v2 = v0.rg;
                v0.rg = v1;
                var v3 = v0.rg;
