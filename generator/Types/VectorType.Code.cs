...
namespace Atma.Math.Types
{
    partial class VectorType
    {
        ...
        public override IEnumerable<Member> GenerateMembers()
        {
            ...
            var absVType = !string.IsNullOrEmpty(BaseType.AbsOverrideType) ? Types[BaseType.AbsOverrideType + Components] : this;
            ...
            if (BaseType.HasArithmetics)
            {
                ...
                else
                {
                    ...
                    yield return new ComponentWiseStaticFunction(Fields, this, "Sqrt", this, "v", $"({BaseTypeName})System.Math.Sqrt((double){{0}})");
                    yield return new ComponentWiseStaticFunction(Fields, this, "InverseSqrt", this, "v", $"({BaseTypeName})(1.0 / System.Math.Sqrt((double){{0}}))");
                    yield return new ComponentWiseStaticFunction(Fields, integerVType, "Sign", this, "v", "System.Math.Sign({0})");
                    ...
                    yield return new ComponentWiseStaticFunction(Fields, this, "Pow", this, "lhs", this, "rhs", BaseTypeCast + "System.Math.Pow((double){0}, (double){1})");
                    yield return new ComponentWiseStaticFunction(Fields, this, "Log", this, "lhs", this, "rhs", BaseTypeCast + "System.Math.Log((double){0}, (double){1})");
            ...
            if (BaseType.IsFloatingPoint)
            {
                ...
                yield return new ComponentWiseStaticFunction(Fields, this, "Acos", this, "v", $"({BaseTypeName})System.Math.Acos((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Asin", this, "v", $"({BaseTypeName})System.Math.Asin((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Atan", this, "v", $"({BaseTypeName})System.Math.Atan((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Cos", this, "v", $"({BaseTypeName})System.Math.Cos((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Cosh", this, "v", $"({BaseTypeName})System.Math.Cosh((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Exp", this, "v", $"({BaseTypeName})System.Math.Exp((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Log", this, "v", $"({BaseTypeName})System.Math.Log((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Log2", this, "v", $"({BaseTypeName})System.Math.Log((double){{0}}, 2)");
                yield return new ComponentWiseStaticFunction(Fields, this, "Log10", this, "v", $"({BaseTypeName})System.Math.Log10((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Floor", this, "v", $"({BaseTypeName})System.Math.Floor({{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Ceiling", this, "v", $"({BaseTypeName})System.Math.Ceiling({{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Round", this, "v", $"({BaseTypeName})System.Math.Round({{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Sin", this, "v", $"({BaseTypeName})System.Math.Sin((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Sinh", this, "v", $"({BaseTypeName})System.Math.Sinh((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Tan", this, "v", $"({BaseTypeName})System.Math.Tan((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Tanh", this, "v", $"({BaseTypeName})System.Math.Tanh((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Truncate", this, "v", $"({BaseTypeName})System.Math.Truncate((double){{0}})");
                yield return new ComponentWiseStaticFunction(Fields, this, "Fract", this, "v", $"({BaseTypeName})({{0}} - System.Math.Floor({{0}}))");
            ...
            if (BaseType.HasArithmetics)
            {
                ...
                yield return new Function(new AnyType("double"), "NormP")
                {
                    ...
                    CodeString = $"System.Math.Pow({Fields.Select(c => $"System.Math.Pow((double){AbsString(c)}, p)").Aggregated(" + ")}, 1 / p)",
            ...
            if (Components == 2 && BaseType.IsFloatingPoint)
            {
                ...
                {
                    GetterLine = "System.Math.Atan2((double)y, (double)x)",
                ...
                yield return new Function(this, "FromAngle")
                {
                    ...
                    CodeString = Construct(this, string.Format("({0})System.Math.Cos(angleInRad), ({0})System.Math.Sin(angleInRad)", BaseTypeName)),
                ...
                {
                    ParameterString = "double angleInRad",
                    CodeString = "(" + Name + ")(double2.FromAngle(Angle + angleInRad) * (double)Length)",
            ...
            else if (BaseType.IsFloatingPoint)
            {
                ...
                yield return new Function(this, "RandomNormal")
                {
                    Static = true,
                    ParameterString = "Random random",
                    CodeString = Construct(this, (BaseTypeCast + "(System.Math.Cos(2 * System.Math.PI * random.NextDouble()) * System.Math.Sqrt(-2.0 * System.Math.Log(random.NextDouble())))").RepeatTimes(Components)),
                ...
                yield return new ComponentWiseStaticFunction(Fields, this, "RandomNormal", this, "mean", this, "variance",
                    BaseTypeCast + "(System.Math.Sqrt((double){1}) * System.Math.Cos(2 * System.Math.PI * random.NextDouble()) * System.Math.Sqrt(-2.0 * System.Math.Log(random.NextDouble()))) + {0}")
                {
                    FirstParameter = "Random random",
