...
namespace Intrinsic.Math
{
    ...
    public static partial class glm
    {
        ...
        /// </summary>
        public static float[,] Values(float3x3 m) => m.Values;
        
        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public static float[] Values1D(float3x3 m) => m.Values1D;
        ...
        /// </summary>
        public static IEnumerator<float> GetEnumerator(float3x3 m) => m.GetEnumerator();
