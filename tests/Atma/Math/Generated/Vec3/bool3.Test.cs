...
namespace  Atma.Math.Generated.Vec3
{
    ...
    public class BoolVec3Test
    {
        ...
        public void Constructors()
        {
            ...
            {
                var v = new bool3(new bool2(false, false));
                Assert.AreEqual(false, v.x);
                Assert.AreEqual(false, v.y);
                Assert.AreEqual(false, v.z);
            }
            {
                var v = new bool3(new bool3(false, false, false));
                Assert.AreEqual(false, v.x);
                Assert.AreEqual(false, v.y);
                Assert.AreEqual(false, v.z);
            }
            {
                var v = new bool3(new bool4(false, false, false, false));
                Assert.AreEqual(false, v.x);
                Assert.AreEqual(false, v.y);
                Assert.AreEqual(false, v.z);
            }
        ...
        public void Indexer()
        {
            var v = new bool3(false, true, true);
        ...
        {
            var v = new bool3(true, true, true);
            var vals = v.Values;
        ...
        public void Operators()
        {
            ...
            var v2 = new bool3(true, false, false);
            var v3 = new bool3(false, false, true);
