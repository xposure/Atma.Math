...
namespace Intrinsic.Math
{
    ...
    public struct bool3x4 : IReadOnlyList<bool>, IEquatable<bool3x4>
    {
        ...
        /// </summary>
        public bool3x4(bool2 c0, bool2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public bool3x4(bool2 c0, bool2 c1, bool2 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this matrix from a series of column vectors. Non-overwritten fields are from an Identity matrix.
        /// </summary>
        public bool3x4(bool3 c0, bool3 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// </summary>
        public static bool3x4 Zero { get; } = new bool3x4(false, false, false, false, false, false, false, false, false, false, false, false);
        
        /// <summary>
        /// Predefined all-ones matrix
        /// </summary>
        public static bool3x4 Ones { get; } = new bool3x4(true, true, true, true, true, true, true, true, true, true, true, true);
        
        /// <summary>
        /// Predefined identity matrix
        /// </summary>
        public static bool3x4 Identity { get; } = new bool3x4(true, false, false, false, false, true, false, false, false, false, true, false);
        ...
        /// </summary>
        public bool Equals(bool3x4 rhs) => ((((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && m02.Equals(rhs.m02)) && ((m03.Equals(rhs.m03) && m10.Equals(rhs.m10)) && m11.Equals(rhs.m11))) && (((m12.Equals(rhs.m12) && m13.Equals(rhs.m13)) && m20.Equals(rhs.m20)) && ((m21.Equals(rhs.m21) && m22.Equals(rhs.m22)) && m23.Equals(rhs.m23))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is bool3x4 && Equals((bool3x4) obj);
        }
        ...
        /// </summary>
        public bool4x3 Transposed => new bool4x3(m00, m10, m20, m01, m11, m21, m02, m12, m22, m03, m13, m23);
        ...
        /// </summary>
        public static bool3x4 operator&(bool3x4 lhs, bool3x4 rhs) => new bool3x4(lhs.m00 && rhs.m00, lhs.m01 && rhs.m01, lhs.m02 && rhs.m02, lhs.m03 && rhs.m03, lhs.m10 && rhs.m10, lhs.m11 && rhs.m11, lhs.m12 && rhs.m12, lhs.m13 && rhs.m13, lhs.m20 && rhs.m20, lhs.m21 && rhs.m21, lhs.m22 && rhs.m22, lhs.m23 && rhs.m23);
