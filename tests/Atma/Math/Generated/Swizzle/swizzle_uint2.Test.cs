...
namespace  Atma.Math.Swizzle.Generated.Swizzle
{
    ...
    public class UintSwizzleVec2Test
    {
        ...
        {
            {
                var ov = new uint2(7u, 6u);
                var v = ov.swizzle.rr;
                Assert.AreEqual(7u, v.x);
                Assert.AreEqual(7u, v.y);
            }
            {
                var ov = new uint2(3u, 3u);
