    ...
    class QuaternionType : AbstractType
    {
        ...
        public override IEnumerable<Member> GenerateMembers()
        {
            ...
            if (BaseType.IsFloatingPoint)
            {
                ...
                {
                    GetterLine = "System.Math.Acos((double)w) * 2.0",
                ...
                if (BaseType.IsFloatingPoint)
                {
                    yield return new Function(this, "Mix")
                    {
                        ...
                        Code = new[]
                        {
                            ...
                            string.Format("    return {0}( (System.Math.Sin((1 - (double)a) * angle) * {1}x + System.Math.Sin((double)a * angle) * {1}y) / System.Math.Sin(angle) );",
                    ...
                    yield return new Function(this, "SLerp")
                    {
                        ...
                        Code = new[]
                        {
                            ...
                            "{",
                            "    var angle = System.Math.Acos((double)cosTheta);",
                            string.Format("    return {0}( (System.Math.Sin((1 - (double)a) * angle) * {1}x + System.Math.Sin((double)a * angle) * {1}z) / System.Math.Sin(angle) );",
                                BaseType.Name == "double" ? "" : "(" + this.Name + ")",
                                BaseType.Name == "double" ? "" : "(" + dquatType.Name + ")"),
                            "}",
                        },
